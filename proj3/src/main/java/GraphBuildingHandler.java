...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private HashMap<String, ArrayList<Node>> locations = new HashMap<>();
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            Node node = new Node(Long.parseLong(
                    attributes.getValue("id")), Double.parseDouble(
                    attributes.getValue("lon")),
                    Double.parseDouble(attributes.getValue("lat")), 0, 0, 0);
            g.addNode(node);
            lastNode = node;
...
//            System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            nodes.addLast(attributes.getValue("ref"));
...
//                System.out.println("Highway type: " + v);
                ...
                // TODO: Could make a hashamp of the key = name, value = linkedlist of nodes
//                locations.put(v, nodes);
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
            ...
            g.setLocation(attributes.getValue("v"), lastNode);
        }
    }
